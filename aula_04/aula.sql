...
-- Pegar um atributo especifico
SELECT * FROM tb_produtos INNER JOIN tb_categorias ON tb_produtos.categoria_id = tb_categorias.id WHERE tb_produtos.categoria_id = 3;

SELECT * FROM tb_produtos INNER JOIN tb_usuarios ON tb_produtos.usuario_id = tb_usuarios.id ORDER BY tb_produtos.nome;
