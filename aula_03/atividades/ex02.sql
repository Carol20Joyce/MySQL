...
values("Calabresa", "Não", 3 , 40.00, 2);
INSERT INTO tb_pizzas (sabor, bordarecheada, quantidade, valor, categoria_id)
values("Nutella", "Sim", 1 , 45.00, 1);
INSERT INTO tb_pizzas (sabor, bordarecheada, quantidade, valor, categoria_id)
values("Mussarela", "Não", 1 , 50.00, 4);
INSERT INTO tb_pizzas (sabor, bordarecheada, quantidade, valor, categoria_id)
values("Churros", "Sim", 3 , 90.00, 3);
INSERT INTO tb_pizzas (sabor, bordarecheada, quantidade, valor, categoria_id)
values("Marguerita", "Sim", 1 , 120.00, 6);
INSERT INTO tb_pizzas (sabor, bordarecheada, quantidade, valor, categoria_id)
values("Romeu e Julieta", "Não", 1 , 110.00, 5);
INSERT INTO tb_pizzas (sabor, bordarecheada, quantidade, valor, categoria_id)
values("Banana com Canela", "Sim", 2 , 85.00, 3);
INSERT INTO tb_pizzas (sabor, bordarecheada, quantidade, valor, categoria_id)
values("Portuguesa", "Sim", 1 , 70.00, 2);

SELECT * FROM tb_pizzas;

SELECT * FROM tb_pizzas WHERE valor > 50.00;

SELECT * FROM tb_pizzas WHERE valor > 40.00 AND valor < 90;
