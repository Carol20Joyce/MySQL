...
-- Busca de texto não expecifico (começo)
SELECT * FROM tb_produtos  WHERE nome LIKE "ra%";

-- Busca de texto não expecifico (independente do lugar)
SELECT * FROM tb_produtos  WHERE nome LIKE "%ra%";

-- Busca de texto não expecifico (final)
SELECT * FROM tb_produtos  WHERE nome LIKE "%ra";

-- Contagem de linhas da tabela
SELECT COUNT(*) FROM tb_produtos;

-- Contagem de linhas da tabela (só os que tem categoria)
SELECT COUNT(categoria_id) FROM tb_produtos;

-- Soma de linhas da tabela
SELECT SUM(preco) FROM tb_produtos;

-- Soma de linhas da tabela + apelido do sum
SELECT SUM(preco) AS Soma_Preço FROM tb_produtos;

-- Média de linhas da tabela + apelido do avg
SELECT AVG(preco) AS Média_Preço FROM tb_produtos;

-- Média de categoria por coluna
